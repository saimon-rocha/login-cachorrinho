...
document.addEventListener("DOMContentLoaded", function () {
    document.getElementById("image").src = "./image/aberto.jpg"
});
...
function esconde() {
    ...
    (type === 'text' ? espia() : document.getElementById("image").src = "./image/cobrindo.jpg")
}

// Função que mostra somente um olho aberto e o outro tapadinho
function espia() {
    document.getElementById("image").src = "./image/espia.jpg"
}
